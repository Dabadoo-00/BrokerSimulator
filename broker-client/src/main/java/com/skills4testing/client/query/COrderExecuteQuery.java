...
import com.skills4testing.client.message.CMessage;
import com.skills4testing.client.message.CMessageDescriptor;
import com.skills4testing.client.message.MsgConst;
