...
public class CConnectionHandler {
    ...
    /**
     * This method is used to send a the request xml of Client to Broker
     * Simulator by calling the
     * <b>handleMessage</b>(String pRecMessage) method of
     * <b>CMDSConnectionHandler</b>. It then take the response xml from the
     * Broker Simulator and make a <b>CMessage</b> from the response xml.
     *
     * @param pConnection the <b>CMDSConnectionHandler</b> that handles the
     * conversation between MCIC and Broker Simulator.
    ...
    /**
     * This is the main metod of this class infact for the whole application. It
     * makes the connection with Broker Simulator then add http headers with the
     * requested message <b>pReqMessage</b>
     * to communicate with Broker Simulator and then send it to Broker
     * Simulator.After sending it receives the response xml from Broker
     * Simulator then extract the HTTP part from the message and returns that to
     * the the requester. Modified by zahid on 07-04-2004 to support utf-8
     * encoding.
     *
     ...
     * to the client.
     *
     * @param outStream stream from client
     * @param xmlPart xml to send to the client
     */
...
//    }
     ...
     *
     * @param pInStream the input stream by which the response from Broker
     * Simulator is received.
    ...
    /**
     * This method create the error xml from the error string and title of the
     * error.
     *
...
//     pTitle = xmlEncode(pTitle);
     ...
     * the String. If any special character(&lt;, &gt;, &, ', ") exists in the
     * String, XML parser shows an error. this method replaces these characters
     * by proper xml entities &lt;, &gt;, &amps;, &apos, &quot; respectively.
     *
