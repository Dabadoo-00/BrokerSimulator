package com.skills4testing.client.message;
...
public class CMessage extends org.xml.sax.helpers.DefaultHandler {
     ...
     *
     * @param message . it contains fromXML method to recieve and parse the
     * incoming messages and toXML method to send the XML messages.
     */
...
//			else
    ...
    public Vector<CMessageDescriptor> registerMessages() throws Exception {
        throw new java.lang.Exception("Override this in the sub class");
    }
     ...
     * @param tagValue value of the element
     */
    ...
    public static String makeXmlElement(String tagName, Integer tagValue)
        ...
        tagName = tagName.trim();
        if (tagValue == null) // It's definitely Empty
        {
     ...
     *
     * @param tagName name of the element
     * @param attributeName value of the element
     * @param attributeValue value of the attbute
     */
     ...
     * @param attributeValue value of the attbute
     *
     * public static String makeXmlEmplyTagWithTwoAttribute(String pTagName,
     * String pFirstAttributeName, String pFirstAttributeValue, String
     * pSecondAttributeName, String pSecondAttributeValue)throws Exception {
     * return MsgConst.kSTART_TAG_ON + pTagName + SPACE + pFirstAttributeName +
     * EQUAL + DOUBLE_QUOTE + xmlEncode(pFirstAttributeValue) + DOUBLE_QUOTE +
     * SPACE + pSecondAttributeName + EQUAL + DOUBLE_QUOTE +
     * xmlEncode(pSecondAttributeValue) + DOUBLE_QUOTE +SLASH+MsgConst.kTAG_OF+
     * CRLF; }
     */
    /**
     * makeXmlEndTag
...
//	}
     ...
     *
     * @param SourceType of the message
     */
     ...
     *
     * @param version of the message sender.
     */
